...
node 'bespin250.east.isi.edu' {
  ...
  notify { 'bespin250 configuration':
    message => 'Running configuration of bespin250.east.isi.edu',
  }
...
#  where to put? flat_interface = eth1
    ...
    folsom_nova_conf      => {
      ...
      ec2_dmz_host              => '65.114.169.250',
      ec2_private_dns_show_ip   => true,
      fixed_ip_disassociate_timeout => '600',
      flat_network_dns          => '10.66.0.1',
...
# Maybe it is this one...
      ...
      xvpvncproxy_base_url      => 'http://10.66.0.1:6081/console' },
...
#  Class['dodcs-selinux'] -> Class['dodcs-repository'] ->  Package['dodcs-openstack'] -> Class['mysql::python'] -> Class['mysql::ruby'] -> Class['openstack::all'] -> Class['dodcs-postproc']
