...
#
# === DODCS Modifications
# Added parameter [package_ensure] Set to 'latest' to push upgrades.
#
...
# DODCS: Are these defaults reasonable?
  ...
  # DODCS kyao try to surpresss keystone user creation
  ...
  class { [
    ...
    'nova::objectstore',
    'nova::volume',
# DODCS: turn off consoleauth service           
    'nova::cert'
#    'nova::cert',           
#    'nova::consoleauth'
  ]:
