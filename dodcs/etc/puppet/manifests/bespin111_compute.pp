...
node 'bespin111.east.isi.edu' {
  ...
  notify { 'bespin111 compute node configuration':
    message => 'Running configuration of bespin111.east.isi.edu as OpenStack compute node.',
  }
...
# For lxc
      ...
      keystone_ec2_url          => "http://10.0.5.8:5000/v2.0/ec2tokens",
