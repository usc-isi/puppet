...
node /single-node-lxc/ {
  ...
  notify { 'single-node-lxc configuration':
    message => 'Running configuration of single-node-lxc',
  }
...
# This uses Puppet Labs's OpenStack modules (maybe only for 2.7.x)
  class { 'openstack::all':
    ...
    fixed_range           => '10.105.0.0/24',
    mysql_root_password   => 'changeme',
    rabbit_host           => '10.105.0.1',
    ...
    nova_user             => 'admin',
    nova_user_password    => 'user_changeme',
    nova_tenant           => 'admin',
    glance_db_password    => 'glance_changeme',
    glance_user           => 'admin',
    glance_user_password  => 'more_changeme',
    glance_tenant         => 'admin',
    purge_nova_config     => false,
    libvirt_type          => 'lxc',
    nova_volume           => 'nova-volumes',
    iscsi_ip_address      => '10.105.0.1',
    verbose               => true,
    package_ensure        => 'present',
    folsom_nova_conf      => {
