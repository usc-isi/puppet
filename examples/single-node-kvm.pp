# single-node-kvm.pp
# Setup a single node as an automated testing host for kvm VMs.
# --------------------------------------------------------------------------- #
...
node /single-node-kvm/ {
  ...
  notify { 'single-node-kvm configuration':
    message => 'Running configuration of single-node-kvm',
  }
...
# This uses Puppet Labs's OpenStack modules (maybe only for 2.7.x)
  class { 'openstack::all':
    ...
    fixed_range           => '10.104.0.0/24',
    mysql_root_password   => 'changeme',
    rabbit_host           => '10.104.0.1',
    rabbit_password       => 'changeme',
    admin_email           => 'admin@example.com',
    admin_password        => 'changeme',
    keystone_db_password  => 'keystone_mysql',
    keystone_admin_token  => '999888777666',
    nova_db_password      => 'nova_changeme',
    nova_user             => 'admin',
    ...
    folsom_nova_conf      => {
      ...
      ec2_dmz_host              => '10.0.5.4',
      ec2_private_dns_show_ip   => true,
      fixed_ip_disassociate_timeout => '600',
      flat_network_dns          => '10.104.0.1',
...
# Maybe it is this one...
      ...
      xvpvncproxy_base_url      => 'http://10.104.0.1:6081/console' },
