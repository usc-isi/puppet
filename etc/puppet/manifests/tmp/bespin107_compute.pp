...
node 'bespin107.east.isi.edu' {
  ...
  notify { 'bespin107 compute node configuration':
    message => 'Running configuration of bespin107.east.isi.edu as OpenStack compute node.',
  }
...
# Maybe it is this one...
      ...
      xvpvncproxy_base_url      => 'http://10.107.0.1:6081/console' },
  }
